...
export const VisionModal: React.FC<VisionModalProps> = ({
  ...
  return (
    <div className="desktop-modal-backdrop fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/85 backdrop-blur-md animate-in fade-in duration-150">
      <div className="desktop-modal-panel w-full max-w-2xl bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl p-6 text-slate-100 relative max-h-[90vh] flex flex-col">
        {/* Header */}
